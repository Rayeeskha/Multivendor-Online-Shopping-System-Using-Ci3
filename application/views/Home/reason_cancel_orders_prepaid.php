...
<div class="container">
	...
	<?= form_open('Home/cancel_Online_orders/'.$ord_details[0]->order_id); ?>	
	...
	<center>
		<a href="<?= base_url('Home/manage_online_pay_purchase'); ?>" class="btn btn-waves-effect waves-light" style="background: black;font-weight: 500;font-size: 15px;text-transform: capitalize;">Back to Home </a>
