...
<div style="margin-left: 15px; margin-right: 15px;">
		...
		<div class="card-content">
			<div class="row">
				<div class="col l6 m12 s12">
					<h6 style="font-weight: 500;font-size: 15px;">Coupon Value : <span style="color: orange;">
						<?= number_format($order_details[0]->coupan_value); ?>
					</span></h6>
					<h6 style="font-weight: 500;font-size: 15px;">Coupon Code : <span style="color: orange;">
						<?= $order_details[0]->coupan_mstercode; ?>
					</span></h6>
				</div>
				<div class="col l6 m12 s12" style="text-align: right;">
					<h6 style="font-weight: 500;font-size: 15px;">Total Amount  : <span class="fa fa-rupee-sign" style="color: orange;">&nbsp;
						<?= number_format($order_details[0]->total_amount); ?>
					</span></h6>
					<h6 style="font-weight: 500;font-size: 15px;">Paid  Amount  : <span class="fa fa-rupee-sign" style="color: green;">&nbsp;
	...
	<div class="card" >
		...
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;border-bottom: 1px solid silver;">
		<?= form_open('Admin/change_online_pay_ord_status/' .$order_details[0]->order_id); ?>
