...
<html>
<head>
	<title>New Registered User - My Shop</title>
	<!--CSS FILE INCLUDE --->
...
<div class="container">
	<div class="card" >
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;">
			<h5 style="font-weight: 500;margin-top: 5px; font-size: 20px;"><span class="fa fa-users"></span>&nbsp;New Registered Customer</h5>
		...
		<div class="card-content" style="padding: 0px">
			<table class="table">
				...
				<?php if(count($new_registration)):
					foreach($new_registration as $n_register):
				 ?>
				<tr>
