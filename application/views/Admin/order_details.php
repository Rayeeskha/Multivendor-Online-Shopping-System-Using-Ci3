...
<div style="margin-left: 15px; margin-right: 15px;">
	...
	<div class="card" >
		...
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;border-bottom: 1px solid silver;">
		<?= form_open('Admin/change_order_status/' .$order_details[0]->order_id); ?>
			...
			<a href="<?= base_url('Admin/print_label/'.$order_details[0]->order_id); ?>" target="_blank" class="btn waves-effect waves-light" style="background: red;text-transform: capitalize;font-weight: 500;font-size: 15px;">Print Slip</a>
		<?= form_close(); ?>
		</div>
	</div>
</div>
