		...
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;">
			...
			<div class="row">
				<div class="col l6 m6 s12">
					<?= form_open('Admin/search_online_orders'); ?>
					<ul id="search_category">
						<li>
							<input type="text" name="order_id" id="input_box" value="<?= set_value('order_id'); ?>" placeholder="Enter Order's ID" required="">
						</li>
						<li>
				...
				<div class="col l6 m6 s12">
					...
					<ul class="dropdown-content" id="category_filter">
						<li><a href="<?= base_url('Admin/filter_online_order/pending_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Pending Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_online_order/processing_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Processing Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_online_order/shipped_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Shipped Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_online_order/packed_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Packed Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_online_order/dispatch_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Dispatch Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_online_order/cancel_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;color: red">Cancel Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_online_order/delivered_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;color: green">Delivered Orders </a></li>
				...
				<tr>
					...
					<td>
						...
						<ul class="dropdown-content action_dropdown" id="order_Action_<?= $order->id; ?>">
							<li><a href="<?= base_url('Admin/view_online_orders/' .$order->order_id); ?>" target="_blank" class="waves-effect" style="border-bottom: 1px solid silver">View Order </a></li>

							<?php if($order->order_status == 'Cancel'): ?>
								<li><a href="<?= base_url('Admin/cancellation_resion/' .$order->order_id); ?>" target="_blank" class="waves-effect">Cancellation resion </a></li>
							<?php endif; ?>
