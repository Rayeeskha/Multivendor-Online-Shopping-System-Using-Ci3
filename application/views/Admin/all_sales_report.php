...
<div style="margin-left: 15px; margin-right: 15px;">
	<div class="card" >
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;">
			<h5 style="font-weight: 500;margin-top: 5px; font-size: 20px;"><span class="fa fa-truck"></span>&nbsp;Manage Sales <span class="right"><a href="#!" class="modal-trigger" data-target="customize_sale_modal" style="font-size: 15px;font-weight: 500;">
			...
			<h6 style="color: grey;font-size: 15px; font-weight: 500;"> Date : 4-Jul-2020 To <?= date('d-M-Y'); ?> 
				<span class="right">
					<a href="<?= base_url('Admin/all_sales'); ?>" style="font-size: 15px;color: red;">
						Reset</a>
				</span>
			</h6>
			...
			<div class="card-content" style="padding: 0px;padding-right: 10px;">
							 ...
							 <?php
							  ...
							  if(count($total_customer)):
							 	foreach($total_customer as $total_cus):
							 		$i++;
							  ?>
							<i><span style="color: grey;">Sold By : <?=  $total_cus->username; ?></span></i> <br/>
						<?php endforeach;
						else: ?>
				...
				<?php endforeach;
					...
					<tr>
						<td style="color: red;text-align: center;font-weight: 500; font-size: 20px;" colspan="4">
							Sale's Not Found
						</td>
					</tr>
				<?php endif; ?>
