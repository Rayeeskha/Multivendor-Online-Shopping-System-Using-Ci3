			...
			<div class="row">
				...
				<div class="col l6 m6 s12">
					...
					<ul class="dropdown-content" id="category_filter">
						<li><a href="<?= base_url('Admin/filter_cod_order/pending_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Pending Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_cod_order/processing_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Processing Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_cod_order/shipped_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Shipped Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_cod_order/packed_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Packed Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_cod_order/dispatch_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver;">Dispatch Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_cod_order/cancel_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver; color: red" >Cancel Orders </a></li>
						<li><a href="<?= base_url('Admin/filter_cod_order/delivered_order'); ?>" class="waves-effect" style="border-bottom:1px dashed silver; color: green">Delivered Orders </a></li>
					</ul>
					<!---Category filter -->
				</div>
			</div>
				...
				<tr>
					...
					<td>
						...
						<ul class="dropdown-content action_dropdown" id="order_Action_<?= $order->order_id; ?>">
							<li><a href="<?= base_url('Admin/order_delete/' .$order->order_id); ?>"
							...
							<li><a href="<?= base_url('Admin/view_order/' .$order->order_id); ?>" target="_blank" class="waves-effect" style="border-bottom: 1px solid silver">View Order </a></li>

							<?php if($order->order_status == 'Cancel'): ?>
								<li><a href="<?= base_url('Admin/resion_of_cancellation/' .$order->order_id); ?>"  class="waves-effect">Resion of Cancellation</a></li>
							<?php endif; ?>
