...
<div style="margin-left: 15px; margin-right: 15px;">
	<div class="card" >
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;">
			<h5 style="font-weight: 500;margin-top: 5px; font-size: 20px;"><span class="fa fa-truck" style="color: red"></span>&nbsp;Manage Prepaid Sales Reports<span class="right"><a href="#!" class="modal-trigger" data-target="customize_sale_modal" style="font-size: 15px;font-weight: 500;">
			...
			<h6 style="color: grey;font-size: 15px; font-weight: 500;"> Date : 4-Jul-2020 To <?= date('d-M-Y'); ?> 
				<span class="right">
					<a href="<?= base_url('Seller_dashboard/all_prepaid_sales'); ?>" style="font-size: 15px;color: red;">
						Reset</a>
				</span>
			</h6>
			...
			<div class="modal" id="customize_sale_modal">
				...
				<?= form_open('Seller_dashboard/search_prepaid_sales_reports'); ?>
				...
				<table class="table">
					...
					<tr>
						...
						<td style="font-size: 14px;font-weight: 500;color: black;">(<?= $sale['COUNT(order_date)']; ?>) Customers <br/>
							<?php $total_customer  = get_all_prepaid_customer($sale['order_date']); ?>
							 <?php
							 	$i = 0;
							  if($total_customer):
						...
						<td style="text-align: right;font-size: 14px;font-weight: 500;color: black;">
							...
							<?php 
								$total_customer  = get_all_prepaid_customer($sale['order_date']);
