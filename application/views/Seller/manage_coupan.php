			...
			<div class="row">
				...
				<div class="col l6 m6 s12">
					...
					<ul class="dropdown-content" id="category_filter">
						<li><a href="<?= base_url('Seller_dashboard/filter_coupans/new_coupans'); ?>" class="waves-effect">New Coupans </a></li>
						<li><a href="<?= base_url('Seller_dashboard/filter_coupans/old_coupans'); ?>" class="waves-effect">Old Coupans </a></li>
						<li><a href="<?= base_url('Seller_dashboard/filter_coupans/highest_price'); ?>" class="waves-effect">Highest Price </a></li>
						<li><a href="<?= base_url('Seller_dashboard/filter_coupans/lowest_price'); ?>" class="waves-effect">Lowest Price </a></li>
					</ul>
					<!---Category filter -->
				</div>
			</div>
				...
				<tr>
					...
					<td>
						...
						<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $coupan->id; ?>">
							<li><a href="<?= base_url('Seller_dashboard/edit_coupan/'.$coupan->id); ?>" style="border-bottom: 1px solid silver"><span class="fa fa-edit" style="color: blue;"></span>&nbsp;Edit</a></li>
							<li><a href="<?= base_url('Seller_dashboard/delete_coupan/'.$coupan->id); ?>" onclick="return confirm('Are you sure you want to  delete this Coupan ?..');" style="border-bottom: 1px solid silver"><span class="fa fa-trash" style="color: red;"></span>&nbsp;Delete</a></li>
							<?php if ($coupan->couponStatus == "0"):  ?>
							<li><a href="<?= base_url('Seller_dashboard/change_coupan_status/'.$coupan->id.'/1'); ?>" style="border-bottom: 1px solid silver">
								<span class="fa  fa-eye-slash"></span>&nbsp;
							Expire</a></li>
							<?php else: ?>
								<li><a href="<?= base_url('Seller_dashboard/change_coupan_status/'.$coupan->id.'/0'); ?>"><span class="fa fa-eye"></span>&nbsp;Active</a></li>
							<?php endif; ?>
						</ul>
						<!---Action Dropdown --->
					</td>
