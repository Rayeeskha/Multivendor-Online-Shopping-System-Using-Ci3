		...
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;">
			...
			<div class="row">
				<div class="col l6 m6 s12">
					<?= form_open('Seller_dashboard/search_products'); ?>
				...
				<div class="col l6 m6 s12">
					<span class="right">
						<button type="button" class="btn waves-effect waves-light dropdown-trigger" data-target="category_filter" style="background: #13124e;box-shadow: none;text-transform: capitalize;height: 38px;margin-top: 15px;">
							<span class="fa fa-filter">&nbsp;Filter Products</span>
						</button>
					</span>
					<!---Category filter -->
					<ul class="dropdown-content" id="category_filter">
						<li><a href="<?= base_url('Seller_dashboard/filter_products/new_products'); ?>" class="waves-effect">New Products </a></li>
						<li><a href="<?= base_url('Seller_dashboard/filter_products/old_products'); ?>" class="waves-effect">Old Products </a></li>
						<li><a href="<?= base_url('Seller_dashboard/filter_products/highest_price'); ?>" class="waves-effect">Highest Price </a></li>
						<li><a href="<?= base_url('Seller_dashboard/filter_products/lowest_price'); ?>" class="waves-effect">Lowest Price </a></li>
					</ul>
					<!---Category filter -->
				</div>
			</div>
		...
		<div class="card-content" style="padding: 0px">
			<table class="table">
				...
				<tr>
					...
					<td style="font-size: 14px;color: green;font-weight: 500">
						<span class="fa fa-rupee-sign"></span><?= number_format($pro->price); ?></td>
					<td style="font-size: 14px;color: grey;font-weight: 500">
						<?php  if($pro->count_sales): echo $pro->count_sales; else: echo "0"; endif; ?>
					</td>
					<td style="font-size: 14px;color: green;font-weight: 500">
						<?php if($pro->status == "0"): ?>
							<h6 style="color: green;font-weight: 500;font-size: 14px;">Active</h6>
							<?php else: ?>
								<h6 style="color: red;font-weight: 500;font-size: 14px;">InActive</h6>
							<?php endif; ?>
					...
					<td>
						...
						<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $pro->id; ?>">
							<li><a href="<?= base_url('Seller_dashboard/edit_product/'.$pro->id); ?>" style="border-bottom: 1px solid silver"><span class="fa fa-edit" style="color: blue;"></span>&nbsp;Edit</a></li>
							<li><a href="<?= base_url('Seller_dashboard/delete_product/'.$pro->id); ?>" onclick="return confirm('Are you sure you want to  delete this Product ?..');" style="border-bottom: 1px solid silver"><span class="fa fa-trash" style="color: red;"></span>&nbsp;Delete</a></li>
							<?php if ($pro->status == "0"):  ?>
							<li><a href="<?= base_url('Seller_dashboard/change_product_status/'.$pro->id.'/1'); ?>" style="border-bottom: 1px solid silver;color: red">
								<span class="fa  fa-eye-slash"></span>&nbsp;
							Inactive</a></li>
							<?php else: ?>
								<li><a href="<?= base_url('Seller_dashboard/change_product_status/'.$pro->id.'/0'); ?>" style="border-bottom: 1px solid silver"><span class="fa fa-eye"></span>&nbsp;Active</a></li>
							<?php endif; ?>
						</ul>
						<!---Action Dropdown --->
					</td>
