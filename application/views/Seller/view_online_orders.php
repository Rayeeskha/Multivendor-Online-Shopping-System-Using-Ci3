...
<html>
<head>
	<title>Prepaid Order's Details - My Shop</title>
	<!--CSS FILE INCLUDE --->
...
<div style="margin-left: 15px; margin-right: 15px;">
		...
		<div class="card-content">
			<div class="row">
				<div class="col l6 m12 s12">
					<h6 style="font-weight: 500;font-size: 14px;">Coupon Value : <span style="color: orange;">
						<?= number_format($order_details[0]->coupan_value); ?>
					</span></h6>
					<h6 style="font-weight: 500;font-size: 14px;">Coupon Code : <span style="color: orange;">
						<?= $order_details[0]->coupan_mstercode; ?>
					</span></h6>
				</div>
				<div class="col l6 m12 s12" style="text-align: right;">
					<h6 style="font-weight: 500;font-size: 14px;">Total Amount  : <span class="fa fa-rupee-sign" style="color: orange;">&nbsp;
						<?= number_format($order_details[0]->total_amount); ?>
					</span></h6>
					<h6 style="font-weight: 500;font-size: 14px;">Paid  Amount  : <span class="fa fa-rupee-sign" style="color: green;">&nbsp;
	...
	<div class="card" >
		...
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;border-bottom: 1px solid silver;">
		<?= form_open('Seller_dashboard/change_online_pay_ord_status/' .$order_details[0]->order_id); ?>
			<h6 style="font-size: 14px;font-weight: 500;color: grey;">Order Status</h6>
			<select name="status" required="" id="update_status" onchange="select_status_file_ord_details()">
			...
			<a href="<?= base_url('Admin/print_label_prepaid/'.$order_details[0]->order_id); ?>" target="_blank" class="btn waves-effect waves-light" style="background: red;text-transform: capitalize;font-weight: 500;font-size: 15px;">Print Slip</a>
		<?= form_close(); ?>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	function select_status_file_ord_details(){
